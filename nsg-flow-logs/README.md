...
This repository contains an Azure Function that collects NSG Flow Logs from Azure and forwards them to Cortex. The Azure Function is deployed using an ARM template that creates all the necessary Azure resources such as private storage account (for internal usage), private endpoints, subnets.
